...
public class OrderRepository  implements RepositoryInterface<Order>{
    ...
    private final DishOrderRepository dishOrderCrudOperations = new DishOrderRepository();
   ...
   @Override
    ...
    public List<Order> findFinishedOrdersBetweenDates(Date startDate, Date endDate) {
        List<Order> orders = new ArrayList<>();
        String sql = "SELECT o.id, o.order_references, o.creation_date " +
                     "FROM orders o " +
    ...
    @Override
    public List<Order> filterByCriteria(List<com.jayway.jsonpath.Criteria> criterias, int page, int size,
